import { BACKEND_ERROR_CODE, createFlatRequest, createRequest } from '@yuencode/axios';
...
export const request = createFlatRequest<App.Service.Response>(
  ...
  },
  {
    async onRequest(config) {
      ...
      // set tenantId
      const tenantId = localStg.get('tenantId') || null;
      Object.assign(headers, { token: Authorization, tenantId });
    ...
    isBackendSuccess(response) {
      ...
      return response.data.code === 200 || response.data.code === '0000';
    },
